    ...
    <main className="min-h-[calc(100vh-4rem)] bg-white">
      <div className="mx-auto max-w-5xl px-4 py-7 sm:px-6 sm:py-10">
        ...
        <div className="mt-6 space-y-3">
          ...
          {!messages.length && <div className="elevated-surface bg-white p-6 text-center sm:rounded-2xl sm:p-8"><Inbox className="mx-auto h-10 w-10 text-slate-400" /><h2 className="mt-3 text-lg font-extrabold text-slate-950">No responder messages</h2><p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-600">There are no active incident offers for responders. New matching requests will appear here automatically.</p></div>}
        </div>
      </div>
    </main>
  );
