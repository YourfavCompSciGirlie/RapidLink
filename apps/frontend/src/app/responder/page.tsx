  ...
  return (
    <main className="min-h-[calc(100vh-4rem)] bg-white">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12 text-center sm:px-6 sm:py-20">
        ...
        <Button asChild className="mt-7"><Link href="/messages"><MessageSquareText className="h-4 w-4" /> Open responder messages <ExternalLink className="h-4 w-4" /></Link></Button>
      </div>
    </main>
  );
}
